...
$fetch_sql = "SELECT nursery.reg_num, nursery.nursery_name, nursery_details.manager, nursery.dateRegistered, nursery.county  FROM `nursery` NATURAL JOIN nursery_details ORDER BY nursery_id DESC" ;
...
if ($result = $conn->query($fetch_sql)) {
    ...
    if ($result->num_rows > 0) {
        while($row = $result->fetch_assoc()) {
           ...
           <td class=\"column6\"><span class=\"label\">County</span><span class=\"cell_info\">$county</span></td>
